...
@section('content')
    <div class="container">
        ...
        <div class="d-flex">
            ...
            <h6 style="margin-right: 0.4rem;"><a class="nav-link text-secondary" href="{{ route('letter.index') }}">Data Surat
                    /</a></h6>
            <h6><a class="nav-link text-primary" href="">Detail Data Surat </a></h6>
        </div>
        ...
        <body>
            <div id="back-wrap">
                <a href="{{ route('letter.index') }}" style="color:white; background-color:grey; text-decoration: none;"
                    class="btn-back" >Kembali</a>
                <a href="{{ route('letter.download-pdf', $letter['id']) }}" class="btn-print">Cetak Surat</a>
            </div>
            <div id="letter">
                <div id="top">
                    <div class="header">
                ...
                <div id="bot">
                    ...
                    <div class="letter_footer">
                        <p>
                            Hormat kami, </br>
                            Kepala SMK Wikrama Bogor </br></br></br></br></br><br><br><br><br><br>
                            (...........................)
                        </p>
                    </div>
                </div>
