...
@section('content')
    ...
    <div class="container" style="">
        ...
        <div class="d-flex">
            ...
            <h6><a class="nav-link text-primary" href="">Data Surat</a></h6>
        </div>
        ...
        <div class="container bg-light p-5" style="border-radius: 10px;">
            ...
            <a href="{{ route('letter.create') }}" style="background-color:grey; color:aliceblue;" class="btn">Tambah</a>
                    ...
                    @foreach ($letters as $item)
                        <tr>
                            ...
                            <td>
                                ...
                                <div class="d-flex">
                                    <a href="{{ route('letter.show', $item['id']) }}"
                                    class="nav-link mt-2 text-primary" style="margin-right: 5px;">Lihat</a>
                                    <a href="{{ route('letter.edit', $item['id']) }}" class="btn btn-primary"
