...
@section('content')
    <div class="container">
        ...
        <div class="d-flex">
            ...
            <h6><a class="nav-link text-secondary" href="{{ route('letter.index') }}">Data Surat / </a></h6>
            <h6><a class="nav-link text-primary" href="">Tambah Data</a></h6>
        </div>

        <a href="{{ route('letter.index') }}" class="btn btn-secondary mb-3">Kembali</a>

        <section class="background" style="background-color: rgb(255, 255, 255); padding:30px; border-radius:10px;">
